...
class StatsRepository{
    ...
    public function getAppStats(){
        ...
        $stats->numberUsers = (float) $this->connection->fetchColumn($sql);
    	
        // number of kanbans
        $sql = "SELECT COUNT(*) FROM kanban";
        $stats->numberKanbans = (float) $this->connection->fetchColumn($sql);

        // number of tasks
        $sql = "SELECT COUNT(*) FROM task";
        $stats->numberTasks = (float) $this->connection->fetchColumn($sql);

        // number of completed (state is either done or archive) tasks
        $sql = "SELECT COUNT(*) FROM task WHERE state = 'done' OR state = 'archive'";
        $stats->numberCompletedTasks = (float) $this->connection->fetchColumn($sql);
    ...
    public function getUserStats($user_id){
        ...
        $stats->numberKanbans = (float) $this->connection->fetchColumn($sql, array((int) $user_id));

        // number of tasks of user user_id
        $sql = "SELECT COUNT(*) FROM task WHERE user_id = ?";
        $stats->numberTasks = (float) $this->connection->fetchColumn($sql, array((int) $user_id));
        ...
        $stats->numberCompletedTasks = (float) $this->connection->fetchColumn($sql, array((int) $user_id));
    ...
    public function getKanbanStats($kanban_id){
        ...
        $stats->numberTasks = (float) $this->connection->fetchColumn($sql, array((int) $kanban_id));
        ...
        $stats->numberCompletedTasks = (float) $this->connection->fetchColumn($sql, array((int) $kanban_id));
