...
namespace multikanban\multikanban\Util;

class Util
{
    /**
    * Returns the slug version of the $cadena string
    * Original code is Doctrine 1's urlize()
    *
    * @param string $cadena Original text string
    * @return string Final slug for the $cadena string
    */
