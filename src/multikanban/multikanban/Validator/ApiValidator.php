...
/*
 * Code originally from @ryanweaver https://github.com/knpuniversity/rest/blob/master/src/KnpU/CodeBattle/Validator/ApiValidator.php
 */

namespace multikanban\multikanban\Validator;
